...
public:
	...
	CCollider* GetMouseCollisionCollider()
	{
		return m_MouseCollisionCollider;
	}
public:
	CollisionSectionInfo* GetSection3D()
	{
		return m_Section3D;
	}
...
public:
	...
	std::vector<int> GetCollisionSection3D(const Vector3& Start, const Vector3& End);
private:
