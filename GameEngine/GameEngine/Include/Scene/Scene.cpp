...
void CScene::SetSkyMesh(CStaticMeshComponent* SkyMesh)
{
	m_SkyMesh = SkyMesh;
}
...
void CScene::PostUpdate(float DeltaTime)
{
	...
	if (m_pSceneMode)
		m_pSceneMode->PostUpdate(DeltaTime);
}
...
CGameObject* CScene::CloneObject2(CGameObject* Obj)
{
    CGameObject* CloneObj = Obj->Clone();
