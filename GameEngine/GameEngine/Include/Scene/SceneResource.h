...
private:
	...
	std::unordered_map<std::string, CSound*>   m_mapSound2D;
	std::unordered_map<std::string, CSound*>   m_mapSound3D;
...
public:
	...
	bool SoundPlay2D(const std::string& Name);
	bool SoundStop2D(const std::string& Name);
	bool SoundPause2D(const std::string& Name);
	bool SoundResume2D(const std::string& Name);

	bool SoundPlay3D(const std::string& Name);
	bool SoundStop3D(const std::string& Name);
	bool SoundPause3D(const std::string& Name);
	bool SoundResume3D(const std::string& Name);

    FMOD::ChannelGroup* FindSoundChannelGroup(const std::string& Name);
	class CSound* FindSound2D(const std::string& Name);
	class CSound* FindSound3D(const std::string& Name);
...
public:
	...
	bool AddAnimationSequenceNotify(const std::string& SequenceName,const std::string& NotifyName, int Frame);
	bool AddAnimationSequenceSound2DNotify(const std::string& SequenceName, const std::string& SoundName, int Frame);
	bool AddAnimationSequenceSound3DNotify(const std::string& SequenceName, const std::string& SoundName, int Frame);
