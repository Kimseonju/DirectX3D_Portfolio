...
bool CCollisionManager::Init()
{
	...
	CreateChannel("MousePicking", Collision_Interaction::Ignore);
	CreateProfile("MousePicking", Collision_Channel::MousePicking);
	return true;
}

bool CCollisionManager::CreateChannel(const std::string& Name,Collision_Interaction Interaction)
{
