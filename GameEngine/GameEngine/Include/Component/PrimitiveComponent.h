...
public:
	void SetAllColor(float Color);
	void SetAllColor(const Vector3& Color);
    void SetAllEmissiveColor(const Vector3& Color);

	void SetEmissiveColor(const Vector3& Color);
	void SetAllOpacity(float Opacity);
	void SetAllTransparency(bool Enable, bool Check=true);
	void SetAllBumpEnable(bool Enable);
public:
