...
public:
	...
	{
		return m_CBuffer->GetDiffuse();
	}

	Vector4 GetAmbient() const
	{
		return m_CBuffer->GetAmbient();
	}

	Vector4 GetSpecular() const
	{
		return m_CBuffer->GetSpecular();
	}
	Vector3 GetDir() const
	{
		return m_CBuffer->GetDir();
	}

	float GetDistance() const
	{
		return m_CBuffer->GetDistance();
	}
	float GetAngleIn() const
	{
		return m_CBuffer->GetAngleIn();
	}
	float GetAngleOut() const
	{
		return m_CBuffer->GetAngleOut();
	}
