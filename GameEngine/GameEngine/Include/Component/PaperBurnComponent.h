...
public:
	void SetTargetMaterial(CMaterial* Mtrl)
	{
		...
		Mtrl->AddSetMaterialCallback<CPaperBurnComponent>("PaperBurn",this, &CPaperBurnComponent::SetMaterialCallback);
		Mtrl->AddResetMaterialCallback<CPaperBurnComponent>("PaperBurn",this, &CPaperBurnComponent::ResetMaterialCallback);
	}
