...
private:
	...
	CGameObject* m_LookAtObject;
	bool		 m_bLookAtObject;
	//Save¿ë
	std::string m_BoneSocketName;
...
private:
	...
	Vector4 m_QuaternionRotation;
	bool	     m_bQuaternion;

public:
	void SetQuaternion(const Vector3& vec);
	void GetQuaternion();
private:
...
public:
	...
	Vector3 GetLookAtYAxis(const Vector3& Pos);
	void LookAtObject(CGameObject* Object);
	void LookAtObject();
	void LookAtObjectActive(bool Enable);
public:
	void Start();
	bool Init();
