...
private:
	...
	std::unordered_map<std::string, class CSound*>   m_mapSound2D;
	std::unordered_map<std::string, class CSound*>   m_mapSound3D;
...
public:
	...
	void ReleaseSound2D(const std::string& Name);
	void ReleaseSound3D(const std::string& Name);
