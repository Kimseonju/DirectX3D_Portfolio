...
public:
	void SetTransparency(bool bTransparency, bool Check=false);
	float GetOpacity()
	{return m_Opacity;}
	...
	void SetBumpEnable(bool Enable);
...
public:
	...
	// UV flow
	void SetFlowEnable(bool bFlow);
	void SetFlowDirection(int bFlowDirection);
...
public:
	...
	bool SetTexture(int Index, const std::string& Name, const TCHAR* FileName,
		const std::string& PathName = TEXTURE_PATH);
	...
	bool SetTextureFullPath(int Index, const std::string& Name, const TCHAR* FullPath);
