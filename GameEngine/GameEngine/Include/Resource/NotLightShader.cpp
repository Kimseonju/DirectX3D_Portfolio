...
CNotLightShader::CNotLightShader()
{
}
...
bool CNotLightShader::Init()
{
	if (!LoadVertexShader(m_Name, "NotLight3DVS", TEXT("NotLight3D.fx"), SHADER_PATH))
		return false;

	if (!LoadPixelShader(m_Name, "NotLight3DPS", TEXT("NotLight3D.fx"), SHADER_PATH))
		return false;
