...
CAnimation3D_Tex::CAnimation3D_Tex() :
	m_pScene(nullptr),
	m_Owner(nullptr),
...
CAnimation3D_Tex::CAnimation3D_Tex(const CAnimation3D_Tex& anim)
{
	*this = anim;
	...
	{
		Sequence2DInfo_* pInfo = new Sequence2DInfo_;
...
void CAnimation3D_Tex::Start()
{
}

bool CAnimation3D_Tex::Init()
{
...
void CAnimation3D_Tex::Update(float DeltaTime)
{
	...
	float	FrameTime = m_CurrentSequence->Sequence->m_FrameTime / m_CurrentSequence->PlayRate;
...
CAnimation3D_Tex* CAnimation3D_Tex::Clone()
{
	return new CAnimation3D_Tex(*this);
}

void CAnimation3D_Tex::SetShader()
{
...
void CAnimation3D_Tex::ResetShader()
{
}

void CAnimation3D_Tex::AddAnimationSequence2D(const std::string& Name, bool Loop)
{
...
void CAnimation3D_Tex::AddAnimationSequence2D(CAnimationSequence2D* Sequence, bool Loop)
{
	Sequence2DInfo_* pInfo = new Sequence2DInfo_;
...
void CAnimation3D_Tex::SetSequencePlayRate(const std::string& Name, float PlayRate)
{
	Sequence2DInfo_* pInfo = FindSequence(Name);
...
void CAnimation3D_Tex::AddSequencePlayRate(const std::string& Name, float PlayRate)
{
	Sequence2DInfo_* pInfo = FindSequence(Name);
...
void CAnimation3D_Tex::ChangeAnimation(const std::string& Name)
{
...
Sequence2DInfo_* CAnimation3D_Tex::FindSequence(const std::string& Name)
{
