...
private:
    ...
    class CPrimitiveComponent** m_pRenderListBloom;
    int m_RenderListBloomCount;
    int m_RenderListBloomCapacity;
	...
	CSharedPtr<CRenderTarget> m_PostProcessTarget;
    ...
    // Bloom
    CSharedPtr<CRenderTarget>   m_BloomTarget;
    CSharedPtr<class CShader>   m_BloomShader;
...
private:
	...
	void RenderBloomTarget(float DeltaTime);
