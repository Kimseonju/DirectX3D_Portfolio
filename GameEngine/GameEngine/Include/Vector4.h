...
struct Vector4
{
	...
	Vector4 CatmullRom(const Vector4& Pos0, const Vector4& Pos1, const Vector4& Pos2, const Vector4& Pos3, float t) const;

    Vector4 TransformCoord(const XMMATRIX& m) const;
	Vector4 SplatW() const;
    Vector4 Divide(const Vector4& Posw) const;
