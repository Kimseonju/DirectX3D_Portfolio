...
class CLobbyWeaponLevelUpDialog :
	public CWidgetWindow
{
	friend class CViewport;

protected:
	CLobbyWeaponLevelUpDialog();
	CLobbyWeaponLevelUpDialog(const CLobbyWeaponLevelUpDialog& widget);
	virtual ~CLobbyWeaponLevelUpDialog();
...
private:
	...
	std::vector<WeaponItemInfo> m_vecItemUpgradeItemInfo;
...
public:
	...
	virtual void Render();
	virtual CLobbyWeaponLevelUpDialog* Clone();
public:
