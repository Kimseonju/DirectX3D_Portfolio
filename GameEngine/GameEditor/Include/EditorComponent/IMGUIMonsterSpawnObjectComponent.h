...
class CIMGUIMonsterSpawnObjectComponent :
	public CIMGUIWidgetComponent
{
public:
	CIMGUIMonsterSpawnObjectComponent();
	virtual ~CIMGUIMonsterSpawnObjectComponent();

private:
	CSharedPtr<CMonsterSpawnObject> m_Object;
